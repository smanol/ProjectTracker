...
export default class EditTest extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:5000/tests/'+ this.props.match.params.id)
            .then(response=> {
                this.setState({
                    ...
                    endDate: response.data.endDate? new Date(response.data.endDate) : '',
                   
                    projectTeams: response.data.projectTeams
                })
            })
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/tests/update' + this.props.match.params.id, project)
